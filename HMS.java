/*
HOTEL MANAGEMENT SYSTEM(HMS)  BY USING JAVA 
DONE BY,
NAME : TEJASWINI  
ROLLNO : A08
SECTION : K18CJ
...
while (!(choice.equalsIgnoreCase("v")||choice.equalsIgnoreCase("a")||choice.equalsIgnoreCase("e")||choice.equalsIgnoreCase("d")||choice.equalsIgnoreCase("f")|| 
         choice.equalsIgnoreCase("s")||choice.equalsIgnoreCase("l")||choice.equalsIgnoreCase("o")||choice.equalsIgnoreCase("q"))); //condition to only let valid range of inputs through.
}
...
if (!(hotel[x].equals("e"))) 
{
System.out.println("Room No. " + x + " is occupied by " + hotel[x]);
...
System.out.println("This room is occupied by: " + hotel[roomNumber]);
System.out.println("");
...
System.out.println("Invalid input! Please Enter a value between 0-9");
System.out.println("");
input.next();//if the input is out of the range of the hotel array this will catch it
} 
